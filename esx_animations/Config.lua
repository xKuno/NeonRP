...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Animacje',
        ['danceemotes'] = "🕺 Tańce",
        ['propemotes'] = "📦 Tańce z rekwizytami",
        ['favoriteemotes'] = "🌟 Ulubione",
        ['favoriteinfo'] = "Wybierz tutaj emotkę, aby ustawić ją jako ulubioną.",
        ['rfavorite'] = "Zresetuj ulubione",
        ['prop2info'] = "❓ Tańce z rekwizytami mogą znajdować się na końcu",
        ['set'] = "Ustawić (",
        ['setboundemote'] = ") jako twoją zbindowaną emotkę?",
        ['newsetemote'] = "~w~ to teraz twoja zbindowana emotka, naciśnij ~g~CapsLock~w~ aby jej użyć.",
        ['cancelemote'] = "Anuluj Animacje",
        ['cancelemoteinfo'] = "~r~X~w~ Anuluje aktualnie odtwarzaną animację",
        ['walkingstyles'] = "Style chodzenia",
        ['resetdef'] = "Przywróć ustawienia domyślne",
        ['normalreset'] = "Normalny (reset)",
        ['moods'] = "Nastroje",
        ['infoupdate'] = "Informacja",
        ['infoupdateav'] = "Informacje (dostępna aktualizacja)",
        ['infoupdateavtext'] = "Dostępna jest aktualizacja, pobierz najnowszą wersję z ~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "Propozycje?",
        ['suggestionsinfo'] = "'dullpear_dev' na forach FiveM, gdzie można znaleźć sugestie dotyczące funkcji / emotikonów! ✉️",
        ['notvaliddance'] = "nie jest prawidłowym tańcem.",
        ['notvalidemote'] = "nie jest prawidłową animacją.",
        ['nocancel'] = "Brak emotki do anulowania.",
        ['maleonly'] = "Przepraszamy, ta emotka jest tylko dla mężczyzn!",
        ['emotemenucmd'] = "Wpisz /emotemenu aby włączyć menu animacji.",
        ['shareemotes'] = "👫 Wspólne animacje",
        ['shareemotesinfo'] = "Zaproś pobliską osobę do animacji",
        ['sharedanceemotes'] = "🕺 Wspólne tańce",
        ['notvalidsharedemote'] = "nie jest prawidłową wspólną animacją.",
        ['sentrequestto'] = "Wysłano prośbę do ~y~",
        ['nobodyclose'] = "Nikt nie jest wystarczająco ~r~blisko~w~.",
        ['doyouwanna'] = "~y~Y~w~ aby zaakceptowac, ~r~L~w~ aby odmówić (~g~",
        ['refuseemote'] = "Animacja odmówiona.",
        ['makenearby'] = "sprawia, że ​​gracz w pobliżu gra",
        ['camera'] = "Naciśnij ~y~G~w~ aby użyć lampy błyskowej.",
        ['makeitrain'] = "Naciśnij ~y~G~w~ żeby padał deszcz banknotów.",
        ['pee'] = "Przytrzymaj ~y~G~w~ aby sikać.",
        ['spraychamp'] = "Przytrzymaj ~y~G~w~ aby pryskać szampanem",
        ['bound'] = "Zbinduj ",
        ['to'] = "do",
        ['currentlyboundemotes'] = " Obecnie zbindowane animacje:",
        ['notvalidkey'] = "nie jest prawidłowym klawiszem.",
        ['keybinds'] = "🔢 Keybindy",
        ['keybindsinfo'] = "Użyj"
  },
  ['fr'] = {
