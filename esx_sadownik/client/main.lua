...
function OpenVehicleSpawnerMenu()
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		ESX.TriggerServerCallback('2PanTRaa_So_cia@31:getVehiclesInGarage', function(vehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner',
			{
				...
				TriggerServerEvent('2PanTRaa_So_cia@31:removeVehicleFromGarage', 'orchard', vehicleProps)
...
function DeleteJobVehicle()
	local playerPed = PlayerPedId()
		...
		if IsInAuthorizedVehicle() then
			...
			--TriggerServerEvent('2PanTRaa_So_cia@31:putVehicleInGarage', 'orchard', vehicleProps)
...
function OpenOrchardActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'orchard_actions',
	{
		...
		elseif data.current.value == 'boss_actions' then
			TriggerEvent('2PanTRaa_So_cia@31:openBossMenu', 'orchard', function(data, menu)
				menu.close()
			end)
		end
...
RegisterNetEvent('sadownik:job1')
AddEventHandler('sadownik:job1', function()
	WorkJob1()
end)

RegisterNetEvent('sadownik:job1b')
AddEventHandler('sadownik:job1b', function()
	WorkJob1b()
end)
...
RegisterNetEvent('sadownik:UDANEPOMARACNZE')
AddEventHandler('sadownik:UDANEPOMARACNZE', function()
	TriggerEvent("pNotify:SendNotification", {text = "Pomyślnie sprzedałeś pomarańcze.", type = "warning", queue = "global", timeout = 5000, layout = "centerLeft"})
	ClearPedSecondaryTask(PlayerPedId())
end)

RegisterNetEvent('sadownik:UDANEJABLKA')
AddEventHandler('sadownik:UDANEJABLKA', function()
	TriggerEvent("pNotify:SendNotification", {text = "Pomyślnie sprzedałeś jabłka.", type = "warning", queue = "global", timeout = 5000, layout = "centerLeft"})
	ClearPedSecondaryTask(PlayerPedId())
end)
...
if not BlipsAdded then
  ...
  SetBlipScale  (blipOrchard5, 0.8)
  SetBlipColour (blipOrchard5, 64)
  ...
  SetBlipScale  (blipOrchard6, 0.8)
  SetBlipColour (blipOrchard6, 64)
  SetBlipAsShortRange(blipOrchard6, true)

  BeginTextCommandSetBlipName("STRING")
  AddTextComponentSubstringPlayerName('Sadownik - Zbieranie owoców')
  ...
  BeginTextCommandSetBlipName("STRING")
  AddTextComponentSubstringPlayerName('Sadownik - Hurtownia soków')
  EndTextCommandSetBlipName(blipOrchard4)
  table.insert(JobBlips, blipOrchard4)

  BeginTextCommandSetBlipName("STRING")
  AddTextComponentSubstringPlayerName('Sadownik - Sprzedaż owoców')
  EndTextCommandSetBlipName(blipOrchard5)
  table.insert(JobBlips, blipOrchard5)

  BeginTextCommandSetBlipName("STRING")
  AddTextComponentSubstringPlayerName('Sadownik - Skup soków')
