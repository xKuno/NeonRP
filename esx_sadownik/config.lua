...
Config.JuiceSellEarnings		  = math.random(340, 360)
Config.AppleSellEarnings		  = math.random(240, 260)
Config.OrangeSellEarnings		  = math.random(240, 260)
Config.NPCJobEarnings             = 1
...
Config.Blips = {
	Cloakroom = {Sprite = 280},
	Apple = {Sprite = 280},
	Orange = {Sprite = 280},
	Juice = {Sprite = 467	},
	SellJuice = {Sprite = 434},
	SellFruits = {Sprite = 434},
}
