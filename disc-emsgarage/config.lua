...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = -699.63,  y = 308.67, z = 82.95},
			{x = 1847.26,  y = 3671.92, z = 33.74},
			{x = -241.29,  y = 6336.42, z = 32.34}
		}
	}
}
...
Config.HeliZones = {
	PoliceHeliGarage = {
		Pos = {
			{x = -701.53,  y = 350.78, z = 93.2},
			{x = 1869.39,  y = 3641.59, z = 34.01}
		}
	}
}
...
Config.CarGarageName = "#EMS - Garaż - Samochód"
...
Config.HeliGarageName = "#EMS - Garaż - Helikopter"
...
Config.BoatGarageName = "#EMS - Garaż - Łódź"
...
Config.ExtraGarageName = "#EMS - Dodatki"
Config.EnableExtraGarageBlip = true

-- Police Car Garage Marker Settings:
Config.PoliceCarMarker = 27 												-- marker type
Config.PoliceCarMarkerColor = { r = 157, g = 50, b = 173, a = 100 } 			-- rgba color of the marker
Config.PoliceCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "Naciśnij ~g~[E]~s~ ,żeby skorzystać z ~y~medycznego garażu~s~"			-- set your desired text here

-- Police Heli Garage Marker Settings:
Config.PoliceHeliMarker = 27 												-- marker type
Config.PoliceHeliMarkerColor = { r = 157, g = 50, b = 173, a = 100 } 		-- rgba color of the marker
Config.PoliceHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "Naciśnij ~g~[E]~s~ ,żeby wyciągnąć ~y~medyczny helikopter~s~"		-- set your desired text here

-- Police Boat Garage Marker Settings:
Config.PoliceBoatMarker = 27 												-- marker type
Config.PoliceBoatMarkerColor = { r = 157, g = 50, b = 173, a = 100 } 		-- rgba color of the marker
Config.PoliceBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "Naciśnij ~g~[E]~s~ ,zeby wyciągnąć ~y~medyczną łódź~s~"		-- set your desired text here

-- Police Extra Garage Marker Settings:
Config.PoliceExtraMarker = 27 												-- marker type
Config.PoliceExtraMarkerColor = { r = 157, g = 50, b = 173, a = 100 } 		-- rgba color of the marker
Config.PoliceExtraMarkerScale = { x = 2.5, y = 2.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.ExtraDraw3DText = "Naciśnij ~g~[E]~s~ ,żeby skorzystać z ~y~ medycznych dodatków~s~"		-- set your desired text here

-- -- Police Cars:
Config.PoliceVehicles = {
    { model = 'ALSrescue1', label = 'AMBULANCE', price = 1 },
    { model = 'emscharg', label = 'FAST UNIT', price = 2 },
    { model = 'emsexplorer', label = 'FORD EXPLORER', price = 3 },
    { model = 'gator', label = 'MERY', price = 4 },
    { model = 'offroadems2', label = 'OFF ROAD', price = 5 },
    { model = 'pd_dirtbike', label = 'MERY(motocykl)', price = 6 },
	{ model = 'FordMustang2019_pd', label = 'Ford Mustang', price = 7 },
}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'polmav', label = 'Maverick - Sierżant', livery = 0, price = 0 }
}

-- Police Boats:
Config.PoliceBoats = {
	{ model = 'SmallBoatEMS', label = 'Ponton', livery = 0, price = 1 },
	{ model = 'HillBoatEMS', label = 'Motorówka', livery = 0, price = 2 },
	{ model = 'largeboat', label = 'Okręt', livery = 0, price = 3 }
}
...
Config.LabelGetVeh = "Wyciągnij pojazd"
Config.LabelPrimaryCol = "Podstawowy"
Config.LabelSecondaryCol = "Drugorzędny"
Config.LabelExtra = "Dodatki"
Config.LabelLivery = "Malowanie"
Config.TitlePoliceGarage = "Policyjny garaż"
Config.TitlePoliceExtra = "Dodatek"
Config.TitlePoliceLivery = "Malowanie"
Config.TitleColorType = "Wybieranie koloru"
Config.TitleValues = "Wartość"

-- ESX.ShowNotifications:
Config.VehicleParked = "~s~Odłożyłeś ~b~Pojazd~s~ do garażu!"
Config.NoVehicleNearby = "Brak ~b~pojazdu~s~ do schowania!"
Config.CarOutFromPolGar = "Wyciągnąłeś ~b~Pojazd~s~ z ~y~Medycznego Garażu~s~!"
Config.HeliOutFromPolGar = "Wyciągnąłeś ~b~Helikopter~s~ z ~y~Medycznego Garażu~s~!"
Config.BoatOutFromPolGar = "Wyciągnąłeś ~b~Łodź~s~ z ~y~Medycznego Garażu~s~!"
Config.VehRepNotify = "Naprawiamy twój  ~b~pojazd. ~s~, Poczekaj chwile!"
Config.VehRepDoneNotify = "Naprawiliśmy twój ~b~pojazd~s~!"
Config.VehCleanNotify = "Czyścimy twój  ~b~pojazd. ~s~, Poczekaj chwile"
Config.VehCleanDoneNotify = "Wyczyściliśmy twój ~b~pojazd~s~!"
...
Config.VehicleLoadText = "Trwa wyciąganie pojazdu z garażu"			-- text on screen when vehicle model is being loaded
...
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
			{x = -702.6044,  y = 304.0993, z = 83.1936}
		}
	}
}
