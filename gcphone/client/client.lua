...
PlaySoundFrontend(-1, 'ERROR', 'HUD_AMMO_SHOP_SOUNDSET', false)
  ESX.ShowNotification("~r~Nie posiadasz telefonu w kieszeniach!")
end
...
AddEventHandler("gcPhone:receiveMessage", function(message)
  ...
  if message.owner == 0 then
    ...
    TriggerEvent('esx:showAdvancedMessage')
    TriggerEvent("FeedM:showAdvancedNotification", "~y~Nowa wiadomość", "~h~~b~"..text, message.message, icon, 5000, 50)
...
AddEventHandler("gcPhone:rejectCall", function(infoCall)
  -- print(Citizen.InvokeNative(0x9A73240B49945C76))
  if inCall == true then
    inCall = false
    if Config.UseMumbleVoIP then
...
RegisterNetEvent("gcPhone:getistalikng")
AddEventHandler("gcPhone:getistalikng", function()
  TriggerServerEvent('iluka:istalking', inCall)
  -- print(inCall)
  -- TriggerServerEvent('iluka:istalking', inCall)
end)
