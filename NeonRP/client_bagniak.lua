...
CreateThread(function()
  while true do
    Citizen.Wait(1)
    if bagniaked then
    TriggerEvent('esx:showAdvancedNotification', "Diler", "", "Ujebałeś się jak tania kurwa")
...
RegisterNetEvent('NeonRP:Przypierdolbagniaka')
AddEventHandler('NeonRP:Przypierdolbagniaka', function(source)
  -- print("elo")
      DoAcid(25000)
end)
CreateThread(function()
