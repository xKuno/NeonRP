...
Config.NPCJobEarnings             = {min = 7000, max = 10000}
Config.MinimumDistance            = 1000
...
Config.AuthorizedVehicles = {
	...
	{
		model = '190e',
		label = 'Mercedes 190E - Rekrut',
	},

	{
		model = 'priustaxi',
		label = 'Toyota Prius - Początkujący',
	},

	{
		model = 'mz3',
		label = 'Mazda Speed 3 - Pracownik',
	},

	{
		model = 'patrol17',
		label = 'Toyota Patrol - Pracownik',
	},

	{
		model = 'taxi4',
		label = 'Alfa Romeo Stelvio - Doświadczony',
	},
	
	{
		model = 'models',
		label = 'Tesla Model S - Zarząd',
	},
}

Config.Vehicles = {
	{
		spawn = '190e', -- dopisujac tu dopisuj na gorze
		name = 'Mercedes 190E - Rekrut',
		grade = 0
	},

	{
		spawn = 'priustaxi',
		name = 'Toyota Prius - Początkujący',
		grade = 1
	},

	{
		spawn = 'mz3',
		name = 'Mazda Speed 3 - Pracownik',
		grade = 2
	},

	{
		spawn = 'patrol17',
		name = 'Toyota Patrol - Pracownik',
		grade = 2
	},
	
	{
		spawn = 'taxi4',
		name = 'Alfa Romeo Stelvio - Doświadczony',
		grade = 3
	},
		
	{
		spawn = 'models',
		name = 'Tesla Model S - Zarząd',
		grade = 4
	},
}
...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = 900.899, y = -171.137, z = 74.12},
