...
Config.ExtraGarageName = "LSPD - Dodatki"
...
Config.MinimumHealth = 850
Config.PoliceDatabaseName = 'police'	-- set the exact name from your jobs database for police
Config.PoliceExtraMarker = 3 												-- marker type
Config.PoliceExtraMarkerColor = { r = 157, g = 50, b = 173, a = 100 } 		-- rgba color of the marker
Config.PoliceExtraMarkerScale = { x = 1.0, y = 1.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.ExtraDraw3DText = "Naciśnij ~g~[E]~s~ ,żeby skorzystać z ~y~ policyjnych dodatków~s~"		-- set your desired text here
...
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
			{x = 456.1371,  y = -1024.9893, z = 29.5022},
			{x = 1868.84,  y = 3681.56, z = 34.65}, ---Shandy
			{x = -445.21,  y = 6047.03, z = 32.34}, ---Paleto
			{x = 609.95,  y = 30.35, z = 89.97},  ---vinewood
			{x = -1127.7798,  y = -835.5875, z = 14.5436},  ---vespucci gora
			{x = -1061.848,  y = -853.5848, z = 5.9188}  ---vespucci dol
