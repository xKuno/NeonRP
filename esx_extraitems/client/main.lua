...
AddEventHandler('esx_extraitems:redgull', function()
	...
	--  TaskPlayAnim(playerPed, "mp_player_intdrink", "loop_bottle", 1.0, -1.0, 2000, 0, 1, true, true, true)
		-- TaskPlayAnim(playerPed, 'mp_player_intdrink', 'loop_bottle', 1.0, -1.0, -1, 2000, 0, 1, true, true, true)
		TaskPlayAnim(playerPed, 'mp_player_intdrink', 'loop_bottle', 8.0, 3.0, -1, 51, 1, 0, 0, 0)
