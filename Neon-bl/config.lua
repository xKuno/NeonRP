...
Config                        = {}
Config.webhook                = "https://discordapp.com/api/webhooks/747404690475712562/SvR2EVirNg_fo843w03FqZklAIX-FvDoZ0YP8e2aiW_hy5X2m8jlGbhDGsw5OM-JX7GK" -- Link do WebHook'a z discorda
Config.MoneyLimit             = 13000000 -- Limit kasy w gotówce (będzie cofać do poprzedniej wartości)
Config.WeaponBL={ -- Blacklista broni
    "WEAPON_SMG",
    "WEAPON_PISTOL50",
    "WEAPON_MINIGUN",
    "WEAPON_RAILGUN",
...
Config.VehicleBL = { -- Blacklista pojazdów
		"RHINO",
	"BUZZARD",
	"buzzard2",
	"rhino",
...
Config.PropsBL = { -- Blacklista propów
