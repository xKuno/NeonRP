...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = 831.170, y = -885.82, z = 24.81},
	...
	ls2 = {
		Pos   = { x = 806.245, y = -904.81, z = 24.81},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
